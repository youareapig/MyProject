 ...
 */
public class IndexSeckillAdapter extends BaseAdapter{
    private List<IndexBean.DataBean.SecondGoodsBean> list;
    private LayoutInflater layoutInflater;
    private Global global;
    public IndexSeckillAdapter(Context context, List<IndexBean.DataBean.SecondGoodsBean> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        IndexBean.DataBean.SecondGoodsBean bean=list.get(position);
        if (convertView==null){

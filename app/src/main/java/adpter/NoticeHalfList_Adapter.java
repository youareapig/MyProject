 ...
 */
public class NoticeHalfList_Adapter extends BaseAdapter{
    private List<NoticeHalfBean.DataBean> list;
    private LayoutInflater layoutInflater;
    private Global global=new Global();
    private String Pic=global.getUrl();
    public NoticeHalfList_Adapter(Activity context, List<NoticeHalfBean.DataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NoticeHalfBean.DataBean bean=list.get(position);
        if (convertView==null){

        ...
        if (result.size() > 0) {
            ...
            picker.setOnAddressPickListener(new AddressPicker.OnAddressPickListener() {
                ...
                public void onAddressPicked(Province province, City city, County county) {
                    if (county == null) {
                        Toast.makeText(activity, "province11111 : " + province + ", city: " + city, Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(activity, "province22222 : " + province + ", city: " + city + ", county: " + county, Toast.LENGTH_LONG).show();
                    }
                }
            });
            picker.show();
